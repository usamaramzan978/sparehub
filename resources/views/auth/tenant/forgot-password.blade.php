                        ...
                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10 col-sm-10 col-12">
                            <div class="card custom-card shadow-none my-auto">
                                <div class="card-body p-5">
                                    ...
                                    @endif
                                    <form class="row gy-3 mt-2" method="POST" action="{{ route('auth.forgot-password.submit') }}">
                                        @csrf
                                        <div class="col-xl-12">
                                            <label for="forgot-email" class="form-label text-default">Email</label>
                                            <div class="position-relative">
                                                <input type="email" class="form-control form-control-lg" id="forgot-email"
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mt-3 mb-0">Back to <a href="{{ route('auth.login') }}"

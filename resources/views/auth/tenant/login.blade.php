                        ...
                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10 col-sm-10 col-12">
                            <div class="card custom-card shadow-none my-auto">
                                <div class="card-body p-5">
                                    ...
                                    @endif
                                    <form class="row gy-3 mt-2" method="POST" action="{{ route('auth.login.submit') }}">
                                        @csrf
                                        <div class="col-xl-12">
                                            ...
                                            <div class="position-relative">
                                                <input type="email" class="form-control form-control-lg" id="login-email"
                                                    name="email" value="owner@demo.local"
                                        ...
                                        <div class="col-xl-12 mb-2">
                                            <label for="login-password" class="form-label text-default d-block">Password
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <a href="javascript:void(0);" class="show-password-button text-muted"
                                                    data-target="login-password" id="button-addon2"><i

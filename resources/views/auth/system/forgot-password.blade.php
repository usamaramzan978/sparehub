                        ...
                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10 col-sm-10 col-12">
                            <div class="card custom-card shadow-none my-auto">
                                <div class="card-body p-5">
                                    ...
                                    <p class="h4 fw-semibold mb-0 text-center">System Forgot Password</p>
                                    <p class="mb-0 text-muted fw-normal text-center">We'll send a reset link to your email.</p>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <form class="row gy-3 mt-2" method="POST" action="{{ route('system.forgot-password.submit') }}">
                                        @csrf
                                        <div class="col-xl-12">
                                            <label for="system-forgot-email" class="form-label text-default">Email</label>
                                            <div class="position-relative">
                                                <input type="email" class="form-control form-control-lg" id="system-forgot-email"
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mt-3 mb-0">Back to <a href="{{ route('system.login') }}"

...
@section('content')
    ...
    <x-breadcrumb title="{{ __('Create Sale Item') }}" :items="$breadcrumbs">
        <x-slot:actions>
    ...
    <div class="card custom-card border-0 shadow-sm h-100">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('tenant.sale-items.store') }}">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <select name="line_type" id="line_type"
                            ...
                            @foreach ($lineTypes as $lineType)
                                <option value="{{ $lineType->value }}" @selected(old('line_type', 'product') === $lineType->value)>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="mechanic_id" id="mechanic_id"
                            ...
                            @foreach ($mechanics as $mechanic)
                                <option value="{{ $mechanic->id }}" @selected(old('mechanic_id') === $mechanic->id)>
                                    {{ $mechanic->name }}
                                </option>
                            @endforeach
                        </select>

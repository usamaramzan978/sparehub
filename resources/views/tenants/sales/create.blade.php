                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="invoice_no" id="invoice_no"
                            class="form-control @error('invoice_no') is-invalid @enderror" value="{{ old('invoice_no') }}"
                            required>
                        @error('invoice_no')
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="invoice_type" id="invoice_type"
                            ...
                            @foreach ($invoiceTypes as $type)
                                <option value="{{ $type->value }}" @selected(old('invoice_type', 'product') === $type->value)>
                                    {{ ucfirst($type->value) }}
                                </option>
                            @endforeach
                        </select>

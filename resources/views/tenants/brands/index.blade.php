                    ...
                    <tbody>
                        @forelse ($items as $brand)
                            <tr>
                                <td>{{ $brand->name }}</td>
                                <td>
                                    <form method="POST" action="{{ route('tenant.brands.toggle-status', $brand) }}">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <div class="btn-list">
                                        <span class="d-inline-block" data-bs-toggle="tooltip" title="{{ __('View') }}">
                                            <button type="button"
                                                ...
                                                data-status="{{ $brand->status->value }}" data-bs-toggle="modal"
                                                data-bs-target="#brandViewModal">
                                        ...
                                        <span class="d-inline-block" data-bs-toggle="tooltip" title="{{ __('Edit') }}">
                                            <button type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#brandEditModal-{{ $brand->id }}">
                            ...
                            @include('tenants.brands.partials.edit', ['brand' => $brand, 'statuses' => $statuses])
                        @empty
                            <tr>

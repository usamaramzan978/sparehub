                        ...
                        <div class="simplebar-content">
                            <nav class="main-menu-container nav nav-pills flex-column">
                                @php
                                    ...
                                    $isSystem = request()->routeIs('tenant.reports.*');
                                ...
                                <ul class="main-menu">
                                    ...
                                    <li class="slide {{ $isDashboard ? 'active' : '' }}">
                                        <a href="{{ route('tenant.dashboard', ['tenant' => $tenantKey]) }}"
                                    ...
                                    <li class="slide has-sub {{ $isMasterData ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isMasterData ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isMasterData ? 'open' : '' }}">
                                            <li class="slide has-sub {{ $isBranches ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isBranches ? 'active' : '' }}">
                                                    {{ __('Branches') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isBranches ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.branches.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.branches.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.branches.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.branches.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.branches.create', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.branches.create') ? 'active' : '' }}">{{ __('Create') }}</a>
                                                    </li>
                                                </ul>
                                            </li>

                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Warehouses') }}</a></li>

                                            <li class="slide {{ $isUnits ? 'active' : '' }}">
                                                <a href="{{ route('tenant.units.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isUnits ? 'active' : '' }}">{{ __('Units') }}</a>
                                            </li>
                                            <li class="slide {{ $isTaxes ? 'active' : '' }}">
                                                <a href="{{ route('tenant.taxes.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isTaxes ? 'active' : '' }}">{{ __('Taxes') }}</a>
                                            </li>
                                            <li class="slide {{ $isCategories ? 'active' : '' }}">
                                                <a href="{{ route('tenant.categories.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isCategories ? 'active' : '' }}">{{ __('Categories') }}</a>
                                            </li>
                                            <li class="slide {{ $isBrands ? 'active' : '' }}">
                                                <a href="{{ route('tenant.brands.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isBrands ? 'active' : '' }}">{{ __('Brands') }}</a>
                                            </li>

                                            <li class="slide has-sub {{ $isProducts ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isProducts ? 'active' : '' }}">
                                                    {{ __('Products') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isProducts ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.products.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.products.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.products.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.products.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.products.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide {{ $isProductPrices ? 'active' : '' }}">
                                                <a href="{{ route('tenant.product-prices.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isProductPrices ? 'active' : '' }}">{{ __('Product Prices') }}</a>
                                            </li>
                                            <li class="slide {{ $isServiceCatalog ? 'active' : '' }}">
                                                <a href="{{ route('tenant.service-catalog.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isServiceCatalog ? 'active' : '' }}">{{ __('Service Catalog') }}</a>
                                            </li>

                                            <li class="slide has-sub {{ $isCustomers ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isCustomers ? 'active' : '' }}">
                                                    {{ __('Customers') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isCustomers ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.customers.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.customers.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.customers.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.customers.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.customers.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide {{ $isCustomerVehicles ? 'active' : '' }}">
                                                <a href="{{ route('tenant.customer-vehicles.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isCustomerVehicles ? 'active' : '' }}">{{ __('Customer Vehicles') }}</a>
                                            </li>
                                            <li class="slide {{ $isVendors ? 'active' : '' }}">
                                                <a href="{{ route('tenant.vendors.index', ['tenant' => $tenantKey]) }}"
                                    ...
                                    <li class="slide has-sub {{ $isWorkshop ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isWorkshop ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isWorkshop ? 'open' : '' }}">
                                            <li class="slide has-sub {{ $isJobCards ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isJobCards ? 'active' : '' }}">
                                                    {{ __('Job Cards') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isJobCards ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.job-cards.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-cards.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.job-cards.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.job-cards.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-cards.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isJobCardServices ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isJobCardServices ? 'active' : '' }}">
                                                    {{ __('Job Card Services') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isJobCardServices ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.job-card-services.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-card-services.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.job-card-services.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.job-card-services.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-card-services.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isJobCardParts ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isJobCardParts ? 'active' : '' }}">
                                                    {{ __('Job Card Parts') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isJobCardParts ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.job-card-parts.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-card-parts.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.job-card-parts.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.job-card-parts.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.job-card-parts.create', ['tenant' => $tenantKey]) }}"
                                    ...
                                    <li class="slide has-sub {{ $isSales ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isSales ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isSales ? 'open' : '' }}">
                                            <li class="slide {{ $isPos ? 'active' : '' }}">
                                                <a href="{{ route('tenant.pos.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isPos ? 'active' : '' }}">{{ __('POS') }}</a>
                                            </li>
                                            <li class="slide has-sub {{ $isSalesInvoices ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isSalesInvoices ? 'active' : '' }}">
                                                    {{ __('Sales Invoices') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isSalesInvoices ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.sales.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sales.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.sales.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.sales.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sales.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isSaleItems ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isSaleItems ? 'active' : '' }}">
                                                    {{ __('Sale Items') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isSaleItems ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.sale-items.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sale-items.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.sale-items.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.sale-items.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sale-items.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isSalePayments ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isSalePayments ? 'active' : '' }}">
                                                    {{ __('Sale Payments') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isSalePayments ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.sale-payments.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sale-payments.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.sale-payments.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.sale-payments.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.sale-payments.create', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.sale-payments.create') ? 'active' : '' }}">{{ __('Create') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="slide {{ $isSaleHolds ? 'active' : '' }}">
                                                <a href="{{ route('tenant.sale-holds.index', ['tenant' => $tenantKey]) }}"
                                    ...
                                    <li class="slide has-sub {{ $isPurchases ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isPurchases ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isPurchases ? 'open' : '' }}">
                                            <li class="slide has-sub {{ $isPurchaseInvoices ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isPurchaseInvoices ? 'active' : '' }}">
                                                    {{ __('Purchases') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isPurchaseInvoices ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.purchases.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchases.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.purchases.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.purchases.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchases.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isPurchaseItems ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isPurchaseItems ? 'active' : '' }}">
                                                    {{ __('Purchase Items') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isPurchaseItems ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-items.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-items.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.purchase-items.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-items.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-items.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isPurchaseReturns ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isPurchaseReturns ? 'active' : '' }}">
                                                    {{ __('Purchase Returns') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isPurchaseReturns ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-returns.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-returns.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.purchase-returns.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-returns.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-returns.create', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.purchase-returns.create') ? 'active' : '' }}">{{ __('Create') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="slide has-sub {{ $isPurchaseReturnItems ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isPurchaseReturnItems ? 'active' : '' }}">
                                                    {{ __('Purchase Return Items') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isPurchaseReturnItems ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-return-items.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-return-items.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.purchase-return-items.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.purchase-return-items.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.purchase-return-items.create', ['tenant' => $tenantKey]) }}"
                                            ...
                                            <li class="slide has-sub {{ $isVendorPayments ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isVendorPayments ? 'active' : '' }}">
                                                    {{ __('Vendor Payments') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isVendorPayments ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.vendor-payments.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.vendor-payments.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.vendor-payments.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.vendor-payments.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.vendor-payments.create', ['tenant' => $tenantKey]) }}"
                                    ...
                                    <li class="slide has-sub {{ $isInventory ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isInventory ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isInventory ? 'open' : '' }}">
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Inventory Stocks') }}</a></li>
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Stock Moves') }}</a></li>
                                        </ul>
                                    </li>

                                    <li class="slide has-sub {{ $isAccessControl ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isAccessControl ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isAccessControl ? 'open' : '' }}">
                                            <li class="slide has-sub {{ $isUsers ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isUsers ? 'active' : '' }}">
                                                    {{ __('Users') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isUsers ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.users.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.users.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.users.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.users.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.users.create', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.users.create') ? 'active' : '' }}">{{ __('Create') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="slide has-sub {{ $isRoles ? 'active open' : '' }}">
                                                <a href="javascript:void(0);" class="side-menu__item {{ $isRoles ? 'active' : '' }}">
                                                    {{ __('Roles') }}
                                                    <i class="ri-arrow-right-s-line side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child2 {{ $isRoles ? 'open' : '' }}">
                                                    <li class="slide {{ request()->routeIs('tenant.roles.index') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.roles.index', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.roles.index') ? 'active' : '' }}">{{ __('List') }}</a>
                                                    </li>
                                                    <li class="slide {{ request()->routeIs('tenant.roles.create') ? 'active' : '' }}">
                                                        <a href="{{ route('tenant.roles.create', ['tenant' => $tenantKey]) }}"
                                                            class="side-menu__item {{ request()->routeIs('tenant.roles.create') ? 'active' : '' }}">{{ __('Create') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Permissions') }}</a></li>
                                        </ul>
                                    </li>

                                    <li class="slide has-sub {{ $isSystem ? 'active open' : '' }}">
                                        <a href="javascript:void(0);" class="side-menu__item {{ $isSystem ? 'active' : '' }}">
                                        ...
                                        <ul class="slide-menu child1 {{ $isSystem ? 'open' : '' }}">
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Tenant Settings') }}</a></li>
                                            <li class="slide {{ $isReports ? 'active' : '' }}">
                                                <a href="{{ route('tenant.reports.index', ['tenant' => $tenantKey]) }}"
                                                    class="side-menu__item {{ $isReports ? 'active' : '' }}">{{ __('Reports') }}</a>
                                            </li>
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Audit Logs') }}</a></li>
                                            <li class="slide"><a href="#" class="side-menu__item">{{ __('Reminders') }}</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="slide">
                                        <form method="POST" action="{{ route('tenant.logout', ['tenant' => $tenantKey]) }}">
                                            @csrf

    ...
    <div class="offcanvas-header border-bottom d-block p-0">
        ...
        <nav class="border-top border-block-start-dashed">
            <div class="nav nav-tabs nav-justified" id="switcher-main-tab" role="tablist"> <button
                    ...
                    aria-selected="false" tabindex="-1">Theme Colors</button> </div>
        </nav>
    </div>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                ...
                <div class="">
                    ...
                    <div class="row switcher-style gx-0">
                        <div class="col-4">
                            <div class="form-check switch-select"> <label class="form-check-label" for="switcher-ltr">
                                    LTR </label> <input class="form-check-input" type="radio" name="direction"
                                    id="switcher-ltr" checked=""> </div>
                        </div>
                        <div class="col-4">
                            <div class="form-check switch-select"> <label class="form-check-label" for="switcher-rtl">
                                    RTL </label> <input class="form-check-input" type="radio" name="direction"
                                    id="switcher-rtl"> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="">
                    ...
                    <div class="row switcher-style gx-0">
                        <div class="col-4">
                            <div class="form-check switch-select"> <label class="form-check-label"
                                    for="switcher-default-width"> compact </label> <input class="form-check-input"
                                    type="radio" name="layout-width" id="switcher-default-width"> </div>
                        </div>
                        <div class="col-5">
                            <div class="form-check switch-select"> <label class="form-check-label"
                    ...
                    <div class="row switcher-style gx-0">
                        ...
                        <div class="col-4">
                            <div class="form-check switch-select"> <label class="form-check-label"
                                    ...
                                    type="radio" name="page-loader" id="switcher-loader-disable" checked="">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="pickr-container-primary" onchange="updateChartColor(this.value)">
                                    <div class="pickr">
                                        ...
                                        <button type="button" class="pcr-button" role="button"
                                            ...
                                            style="--pcr-color: rgba(115, 93, 255, 1);"></button>

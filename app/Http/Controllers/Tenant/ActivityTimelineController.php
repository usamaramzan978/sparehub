...
final class ActivityTimelineController extends Controller
{
    ...
    private function eventMeta(string $event): array
    {
        return match ($event) {
            ...
            'branch_switched' => ['title' => 'Branch', 'badge_class' => 'bg-primary-transparent text-primary'],
            'branch_created', 'branch_updated', 'branch_deleted' => ['title' => 'Branch', 'badge_class' => 'bg-primary-transparent text-primary'],

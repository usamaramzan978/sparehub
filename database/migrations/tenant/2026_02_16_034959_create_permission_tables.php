...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        throw_if(empty($tableNames), 'Error: config/permission.php not found and defaults could not be merged. Publish package config before proceeding, or drop tables manually.');
